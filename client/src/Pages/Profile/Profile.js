          ...
          <div className="card user-card-full">
            <div className="row m-l-0 m-r-0">
              <div className="col-sm-4 bg-c-lite-green user-profile">
                <div className="card-block text-center text-white" style={{width: '180px'}}>
                  ...
                  <p className="m-b-10 f-w-600">Email</p>
                      ...
                      <h6 className="text-muted f-w-400">{(user && user.phone) || ""}</h6>
                </div>
              ...
              <div className="col-sm-8">
                <div className="card-block">
                  ...
                  <h6 className="m-b-20 m-t-40 p-b-5 b-b-default f-w-600">Mes Annonces
                  </h6>
                  <div className="row">
